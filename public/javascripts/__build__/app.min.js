...
/******/ 	__webpack_require__.p = "./public/javascripts/__build__/";
...
/***/ function(module, exports, __webpack_require__) {
	...
	//加载依赖
	var createStoreWithMiddleware = (0, _redux.applyMiddleware)(_reduxThunk2.default, reduxRouterMiddleware)(_redux.createStore);

	if (false) {
	  var store = createStoreWithMiddleware(_index.reducer, {});
	} else {
	  //载入redux debug插件

	  var configureStore = function configureStore(initialState) {
	    var store = createStoreWithMiddleware(_index.reducer, initialState, window.devToolsExtension ? window.devToolsExtension() : undefined);
	    return store;
	  };
	  // Store
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isHostObject = __webpack_require__(20),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _History2 = __webpack_require__(67);

	var _History3 = _interopRequireDefault(_History2);

	exports.History = _History3['default'];

	var _Lifecycle2 = __webpack_require__(68);
	...
	var _useRoutes2 = __webpack_require__(70);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibCreateHashHistory = __webpack_require__(26);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AsyncUtils = __webpack_require__(39);

	var _Actions = __webpack_require__(29);

	var _createLocation2 = __webpack_require__(40);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createRouterHistory = __webpack_require__(79);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _currentUser = __webpack_require__(85);
	...
	//导入初始化登录状态
	var INIT_STATE = {
	    status: _login.LOGIN_STATUS_OUT,
	    info: {
	        name: '',
	        role: ''
	    },
	...
	function login() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? _currentUser2.default : arguments[0];
	    var action = arguments[1];

	    switch (action.type) {
	        case _login.LOGIN_REQUEST:
	            return Object.assign({}, state, {
	                status: _login.LOGIN_STATUS_LOAD
	            });
	            break;
	        case _login.LOGIN_RECEIVE:
	            return Object.assign({}, state, {
	                status: _login.LOGIN_STATUS_IN,
	                info: action.info
	            });
	            break;
	        case _login.LOGIN_ERROR:
	            return Object.assign({}, state, {
	                status: _login.LOGIN_STATUS_ERROR,
	                msg: action.msg
	            });
	            break;
	        case _login.LOGOUT_REQUEST:
	            return Object.assign({}, state, {
	                status: _login.LOGIN_STATUS_LOAD
	            });
	            break;
	        case _login.LOGOUT_RECEIVE:
	            return Object.assign({}, state, INIT_STATE);
	            break;
	        case _login.LOGOUT_ERROR:
	            return Object.assign({}, state, {
	                status: _login.LOGIN_STATUS_ERROR,
	                msg: action.msg
	            });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.LOGIN_STATUS_ERROR = exports.LOGIN_STATUS_LOAD = exports.LOGIN_STATUS_IN = exports.LOGIN_STATUS_OUT = exports.LOGOUT_ERROR = exports.LOGOUT_RECEIVE = exports.LOGOUT_REQUEST = exports.LOGIN_ERROR = exports.LOGIN_RECEIVE = exports.LOGIN_REQUEST = undefined;
	exports.loginRequest = loginRequest;
	exports.loginReceive = loginReceive;
	exports.loginError = loginError;
	exports.loginPost = loginPost;
	exports.logoutRequest = logoutRequest;
	exports.logoutReceive = logoutReceive;
	exports.logoutError = logoutError;
	exports.logoutPost = logoutPost;

	var _isomorphicFetch = __webpack_require__(87);
	...
	var LOGOUT_RECEIVE = exports.LOGOUT_RECEIVE = 'LOGOUT_RECEIVE';
	var LOGOUT_ERROR = exports.LOGOUT_ERROR = 'LOGOUT_ERROR';
	//状态
	var LOGIN_STATUS_OUT = exports.LOGIN_STATUS_OUT = 'out'; //登出
	var LOGIN_STATUS_IN = exports.LOGIN_STATUS_IN = 'in'; //登入
	var LOGIN_STATUS_LOAD = exports.LOGIN_STATUS_LOAD = 'load'; //加载
	var LOGIN_STATUS_ERROR = exports.LOGIN_STATUS_ERROR = 'error'; //出错
	/*
	 * action 创建函数
	 */
	//登录
	...
	function loginPost(data) {
		return function (dispatch) {
			...
			var headers = new Headers(data);
			var request = new Request(_config.API_LOGIN, {
				method: 'GET',
				headers: headers
			});
	...
	function logoutPost() {
		return function (dispatch) {
			...
			var request = new Request(_config.API_LOGOUT, {
				method: 'GET'
			});
			(0, _isomorphicFetch2.default)(request).then(function (response) {
				return response.json();
				...
				return dispatch(loginError('网络错误,请重试'));
			});
		};
	}
...
/***/ function(module, exports) {
	...
	//API配置
	var API_PATH = '/api/';
	var API_LOGIN = exports.API_LOGIN = API_PATH + 'login.json';
	var API_LOGOUT = exports.API_LOGOUT = API_PATH + 'loginout.json';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Index = function (_Component) {
	    ...
	    _createClass(Index, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            dispatch((0, _auth.authLoginStatus)(login.status, false));
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            var LoginBlock = _react2.default.createElement(_login2.default, { onLoginSubmit: function onLoginSubmit(data) {
	                    return dispatch((0, _login3.loginPost)(data));
	                }, status: login.status, msg: login.msg });
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(
	...
	exports.default = (0, _reactRedux.connect)(_index.propMap)(Index);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Login = function (_Component) {
	    ...
	    _createClass(Login, [{
	        ...
	        value: function render() {
	            ...
	            switch (status) {
	                case _login.LOGIN_STATUS_ERROR:
	...
	Login.propTypes = {
	    onLoginSubmit: _react.PropTypes.func.isRequired,
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.authLoginStatus = authLoginStatus;
	 ...
	 */
	//加载依赖
	function authLoginStatus(login_status) {
		var check_status = arguments.length <= 1 || arguments[1] === undefined ? true : arguments[1];
		...
		return function (dispatch) {
			//检测登录,当未登录时,跳转到登录页
			if (check_status && login_status !== _login.LOGIN_STATUS_IN) {
				dispatch((0, _reactRouterRedux.push)('/'));
			}
